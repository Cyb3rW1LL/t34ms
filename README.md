...
> 2. Copy the 4 .mp4 files that are currently in there and save them off in a file elsewhere (just in case). An easy visual cue for .mp4s is the film "stripe" along the sides of the file. In T34Ms "Video effects and settings," it will look like the image on the right:
     <p align="left">
