...
> 4. Download Gifs (check them for malware) -- or just use your own .mp4s -- as per teams size standards, convert them to .mp4s (scan again for malware if doing this from the web). If you are already using an adequately sized .mp4, move to step (5)
     <p align="left">
